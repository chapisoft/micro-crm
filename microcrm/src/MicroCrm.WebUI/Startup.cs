...
namespace MicroCrm.WebUI
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      var connectionString = Configuration.GetConnectionString(nameof(MicroCrmDbContext));
      ...
      services.AddDbContext<MicroCrmDbContext>(options => options.UseSqlServer(connectionString));
      ...
      services.AddScoped<DbContext, MicroCrmDbContext>();
      ...
      services.AddCap(x =>
      {
        x.UseEntityFramework<MicroCrmDbContext>();
    ...
    public async void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
    {
      ...
      app.UseSwaggerUI(c =>
      {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "MicroCrm.WebApi");
      });
